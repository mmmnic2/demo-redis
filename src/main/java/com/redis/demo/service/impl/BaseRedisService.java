...
public class BaseRedisService implements IBaseRedisService {
    ...
    // lấy các field của map trong key
    @Override
    ...
    //phương thức lấy tất cả các value add vào list với key bắt đầu bằng chuỗi fieldPrefix__
    @Override
    ...
    // phương thức lấy các key trong hash
    @Override
